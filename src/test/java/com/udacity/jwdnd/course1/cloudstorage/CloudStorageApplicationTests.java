...
class CloudStorageApplicationTests {
	...
	//Test unauthorized user delete file
	//Test unauthorized user edit note
	//Test unauthorized user delete note
	//Test unauthorized user edit credential
	//Test unauthorized user delete credential
